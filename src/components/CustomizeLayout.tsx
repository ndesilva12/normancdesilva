...
const DEFAULT_QUICK_ACCESS: LayoutItem[] = [
  ...
  { id: "contacts", name: "Contacts", visible: true, order: 2, color: "#8b5cf6" },
  { id: "files", name: "Files", visible: true, order: 3, color: "#6366f1" },
  { id: "notes", name: "Notes", visible: true, order: 4, color: "#a78bfa" },
  { id: "raindrop", name: "Bookmarks", visible: true, order: 5, color: "#06b6d4" },
  { id: "spotify", name: "Spotify", visible: true, order: 6, color: "#10b981" },
  { id: "news", name: "News", visible: true, order: 7, color: "#64748b" },
  { id: "market", name: "Market", visible: true, order: 8, color: "#3b82f6" },
  { id: "inoreader", name: "RSS", visible: true, order: 9, color: "#10b981" },
  { id: "trending", name: "Trending", visible: true, order: 10, color: "#14b8a6" },
  ...
  { id: "contact-finder", name: "Contact Finder", visible: true, order: 14, color: "#6366f1" },
  { id: "image-lookup", name: "Image Lookup", visible: true, order: 15, color: "#a78bfa" },
